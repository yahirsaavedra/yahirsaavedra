...
<li>💻 Backend skills in TypeScript, Python, C++, C# and Java.</li>
<li>🚀 Frontend skills in React, Tailwind CSS, Flutter and Vite.</li>
<li>📱 Mobile app development specialization.</li>
